...
{
    gl.viewport(0, 0, canvas.width, canvas.height); // HTML starts at 0,0 at the top let corner
}
...
function createTriangle(gl) 
{
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, vertexBuffer); // everything will be applied to vertex buffer
    let verts = [
        0.0,  0.5,  0.0,
        -.5,  -.5,  0.0,
        .5, -.5,  0.0,
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(verts), gl.STATIC_DRAW); // implicitely assigns buffer data to vertex buffer. It was previously binded
